...
the_god_father = media.Movie('The God Father',
                             ...
                             ,
                             'https://resizing.flixster.com/YniHouvJXo_Hz6sgwbGDOSHou3A=/206x305/v1.bTsxMTE3MTYxMjtqOzE3NDk5OzEyMDA7ODAwOzEyMDA' # NOQA697
                             ,
...
schindlers_list = media.Movie("Schindler's List",
                              "In German-occupied Polandduring World War II, "
                              "Oskar Schindler gradually becomes concerned for"
                               "hisJewish workforce after witnessing their persecution by the Nazi Germans."
                              ,
...
citizen_kane = media.Movie('Citizen Kane',
                           'Following the death of a publishingtycoon, '
                           'news reporters scramble to discover the meaning'
                           ' of his finalutterance.'
                           ,
...
wall_e = media.Movie('WALL-E ',
                     'In the distant future, a smallwaste-collecting '
                     'robot inadvertently embarks on a space journey'
                     ' that willultimately decide the fate of mankind.'
                     ,
                     'http://www.gstatic.com/tv/thumb/movieposters/174374/p174374_p_v8_ab.jpg' # NOQA697
...
ratatouille = media.Movie('Ratatouille',
                          ...
                          ,
                          'http://www.gstatic.com/tv/thumb/dvdboxart/165058/p165058_d_v8_aa.jpg' # NOQA697
                          ,
                          'https://www.youtube.com/watch?v=c3sBBRxDAqk')

finding_nemo = media.Movie('Finding Nemo ',
                           'After his son is captured in theGreat Barrier'
                           ' Reef and taken to Sydney, a timid clownfish'
                           ' sets out on ajourney to bring him home. '
                           ,
                           'http://t1.gstatic.com/images?q=tbn:ANd9GcSoStMb2jeN136xQhf2g3ROpTB9Dker9IlfGbMbwYB3ruC9VcOj' # NOQA697
                           ,
                           'https://www.youtube.com/watch?v=wZdpNglLbt8'
                           )

the_jungle_book = media.Movie('The Jungle Book',
                              'Bagheera the Panther andBaloo the Bear'
                              ' have a difficult time trying to convince '
                              'a boy to leave thejungle for human civilization. '
                              ,
...
up = media.Movie('Up',
                 ...
                 ' inadvertently taking ayoung stowaway. '
                 ,
